...
*   - 각 키는 유일해야 하며, 종목된 키를 사용할 수 없다. 동일한 키에 대해 값을 변경하면 기존 값이 새 값으로 대체된다.
...
*   - 요소의 순서를 보장하려면 LinkedHashMap을 사용할 수 있다.
*
* 4. 성능 :
...
*   - 해시 테이블의 크기가 작으면 해시 충돌 발생할 가능성이 높아지므로 적절한 초기 용량로드 팩터를 설정하는 것이 좋다.
*/

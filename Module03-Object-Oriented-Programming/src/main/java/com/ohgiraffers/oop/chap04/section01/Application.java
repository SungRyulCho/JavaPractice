 ...
 *   - 예 : car 마다 Accelerate()를 다르게 쓰면 통일성이 없어짐.
 */
public class Application {
    public static void main(String[] args) {

        /*
         * animal 을 상속받는 모든 동물이 makeSound()라는 행위를 가져야 한다고 가정하면
         * 이를 구현할 수 있도록 강제화해야 하는데 이를 추상 메서드를 통해 구현할 수 있다.
         * <p>
         * 추상화는 animal 클래스를 abstract 클래스로 만들고 "makeSound()를 "abstract"메서드로 선언한다.
         * 추상 메서드 : 몸통은 없지만, 너희 자식들은 반드시 이 메서드를 구현해야해! 라는 강력한 규칙이자 책임을 부여한다.
